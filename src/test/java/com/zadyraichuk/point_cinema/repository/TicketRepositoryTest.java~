...
class TicketRepositoryTest {
    ...
    void testFindAll() {
        ...
        for (Ticket a : tickets) {
            assertTrue(foundTickets.contains(a), "The found tickets should contain all tickets saved before");
        }
    }
    ...
    void testSaveAll() {
        ...
        for (Ticket a : savedTickets) {
            assertNotNull(a.getId(), "Each saved ticket should have a generated ID");
        }
    ...
    void testFindByDate(LocalDate date,
        ...
        for (int index : expectedTicketIndexes) {
            assertTrue(foundTickets.contains(tickets[index]), "Ticket should be in the result");
        }
    }
    ...
    void testDeleteByDateToBefore(LocalDate date,
        ...
        for (int index : expectedRemovedTicketIndexes) {
            assertFalse(foundSeances.contains(tickets[index]), "Ticket should not be in the result");
        }
    }
